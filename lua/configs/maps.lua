...
-- buffer navigation - not really needed, but it can be useful
...
vim.cmd('nnoremap <silent><leader>p :let @"=getreg(\'*\')<CR><C-[>:let @0=getreg(\'+\')<CR>:echo \"paste ready!\"<CR>')
